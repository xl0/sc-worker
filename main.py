...
if __name__ == "__main__":
    ...
    # Stale redis
    redisUrl = os.environ.get("REDIS_URL", None)
    ...
    try:
        ...
        if redis_worker_thread: redis_worker_thread.start()
        upload_thread.start()
        ...
        if redis_worker_thread: redis_worker_thread.join()
        upload_thread.join()
